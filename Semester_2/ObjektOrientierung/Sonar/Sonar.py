...
Customized version of this script

http://inventwithpython.com/sonar.py

Calculate the euclidian distance instead of using bounding box
"""
...
def makeMove(board, chests, x, y):
    ...
    for c in chests:
        print(c)
    for cx, cy in chests:
        distance = round(math.sqrt(math.fabs(cx-x)**2+ math.fabs(cy-y)**2),2)
